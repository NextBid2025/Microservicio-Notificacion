...
{
    /// <summary>
    /// Value Object que representa el identificador único de una subasta.
    /// </summary>
    public class SubastaId
    {
        ...
        /// </exception>
        public SubastaId(Guid value)
        {
            if (value == Guid.Empty)
                throw new ValueObjectValidationException("El identificador de subasta no puede estar vacío.");
